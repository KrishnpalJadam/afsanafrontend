...
const AddLead = () => {
  ...
  const [newInquiry, setNewInquiry] = useState({
    ...
    preferredCountries: [],
    lead_status: "Converted to Lead", // Add lead_status field with default value
  });
  ...
  const handleCloseInquiryModal = () => {
    ...
    setNewInquiry({
      ...
      preferredCountries: [],
      lead_status: "Converted to Lead", // Reset lead_status when closing modal
    });
  };
  ...
  const handleAddInquiry = async (e) => {
    ...
    const requestData = {
      ...
      lead_status: "Converted to Lead", // Ensure lead_status is set to converted
    };
    ...
    try {
      ...
      if (response.status === 201) {
        Swal.fire({
          ...
          // You might want to add fetchInquiries() here if needed
        });
      } else {
        Swal.fire({
          title: 'Success!',
