...
//     alert(`WhatsApp message sent to: ${phone}`);
//   };
...
//       <h2 className="mb-4">Communication Follow-Up</h2>

//       <div className="table-responsive">
//         <table className="table table-striped table-bordered table-hover text-center text-nowrap">
//           <thead>
//             <tr>
//               <th>Name</th>
//               <th>Email</th>
